...
export const ErrorIds = {
  ...
  // Rewards errors (ERR_RWD_xxx)
  REWARDS_INSUFFICIENT_POINTS: 'ERR_RWD_001',
  REWARDS_INVALID_AMOUNT: 'ERR_RWD_002',
  REWARDS_NOT_FOUND: 'ERR_RWD_003',
  REWARDS_EXPIRED: 'ERR_RWD_004',
  REWARDS_REDEMPTION_FAILED: 'ERR_RWD_005',
