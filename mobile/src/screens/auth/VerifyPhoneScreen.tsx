...
interface VerifyPhoneScreenProps extends NativeStackScreenProps<any, 'VerifyPhone'> {}
...
export const VerifyPhoneScreen: React.FC<VerifyPhoneScreenProps> = ({
  ...
  const handleVerify = async (verificationCode?: string) => {
    ...
    try {
      // TODO: Call API to verify phone
      // await authApi.verifyPhone({ phone, code: codeToVerify });
  ...
  return (
    ...
    >
      <View style={styles.content}>
        ...
        >
          <Text style={styles.changePhoneText}>Wrong number? Go back</Text>
        </TouchableOpacity>
      </View>
    </KeyboardAvoidingView>
  );
